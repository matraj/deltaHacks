...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top" background="blurcity.jpg">
    ...
    if ($isUserFound) {
        ...
        echo "<script type='text/javascript'>window.location.href = 'http://localhost/deltaHacks/infopage.php';</script>";
    } else {
        echo "go to error page";
        echo "<script type='text/javascript'>window.location.href = 'http://localhost/deltaHacks/notfound.html';</script>";
    }
    ?>
